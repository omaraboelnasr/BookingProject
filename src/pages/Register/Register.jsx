      ...
      <div className=' mt-9'>
        <div>
          <form action="">
            ...
            <button className='flex w-full justify-center rounded-sm bg-blue-600 py-3 text-lg my-5 font-semibold leading-6 text-white shadow-sm hover:bg-blue-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-blue-800' onClick={()=>navigate("/create")}>Continue with email</button>
          </form>
        </div>
        <div className='flex'>
