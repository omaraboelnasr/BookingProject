	...
	useEffect(() => {
		...
		const getHotelsByCity = async () => {
			try {
				...
				const approvedHotels = hotelsData.filter(
				...
				<div className="row">
					...
					<div className="col-md-8">
						{hotels.map((hotel) => (
							<div
								key={hotel._id}
								className="flex justify-between pt-5 max-w-[990px] mx-auto"
							>
								<div className="mt-1 mb-1">
									<div className="flex border rounded-md p-3 h-auto w-full hover:bg-blue-200 hover:shadow-md">
										...
										<div className="p-0 m-0">
											<h4 className="font-bold text-blue-800 mr-2 ml-2">
												{i18n.language === "ar"
													? hotel.hotelName_ar
													: hotel.hotelName}
											</h4>
											<div className="flex">
												<p className="text-blue-500 text-decoration-underline mr-2 ml-2">
													{i18n.language === "ar"
											...
											<div className="hidden mr-2 ml-2">
												{i18n.language === "ar"
													? hotel.hotelCity_ar
													: hotel.hotelCity}
											</div>
											<div>
												<p className="p-0  mr-2 ml-2">
													{i18n.language === "ar"
														? hotel.hotelSubDescription_ar
														: hotel.hotelSubDescription}
												</p>
											</div>
										</div>
										...
										<div className="flex flex-col p-0 w-[35%]">
											<div className="flex space-x-4 mb-2">
												<div className="">
													<p className="font-semibold p-0 m-1">
														{t("good")}
													</p>
													<p className="p-0 m-0">
														{t("reviews")}{" "}
												...
												<div>
													<div className="p-3 mt-1 bg-blue-800 text-white rounded-lg">
														{hotel.hotelRating}
													</div>
												</div>
											</div>
											<div>
												<button
													className="bg-blue-600 p-3 rounded-lg mt-3 mr-16"
													onClick={() =>
														handleGetRooms(
															hotel._id
														)
